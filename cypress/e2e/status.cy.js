describe("status selection", () => {
  ...
  it("can set, remove, stores and reset status", () => {
    ...
    cy.get("#hero-status-display").click();
    cy.get("#hero-status-display > li").contains("A cooperative approach");
    ...
    cy.get("#hero-status-display").click();
    cy.get("#hero-status-display > li").contains("A cooperative approach");
    cy.get("#hero-status-display > li").contains("A friendly approach");
  ...
  it("can search for an status", () => {
    ...
    cy.get("#hero-status-display").click();
    cy.get("#hero-status-display > li").contains("A mysterious click");
