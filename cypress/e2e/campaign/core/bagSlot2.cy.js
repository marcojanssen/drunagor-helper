describe("bag item selection", () => {
  beforeEach(() => {
    ...
    it("has multiple items available", () => {
      ...
      cy.get(".hero-bag2-wrapper li").should("have.length", 149);
  ...
  it("can search for an item", () => {
    cy.get(".hero-bag2-wrapper .hero-item").type("Heavy Th");
    cy.get(".hero-bag2-wrapper li").first().click();
    cy.get(".hero-bag2-wrapper .hero-item").should("have.value", "Heavy Thornmail");
  });
  it("can stash item", () => {
    cy.get(".hero-bag2-wrapper .hero-item").click();
    cy.get(".hero-bag2-wrapper li").first().click();
