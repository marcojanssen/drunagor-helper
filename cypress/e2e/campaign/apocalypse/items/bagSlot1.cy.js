describe("bag item selection", () => {
  beforeEach(() => {
    ...
    it("has multiple items available", () => {
      ...
      cy.get(".hero-bag1-wrapper li").should("have.length", 108);
  ...
  it("can set and remove bag item", () => {
    ...
    cy.get(".hero-bag1-wrapper .hero-item").should("have.value", "Artisan's Tools (Veteran)");

    cy.get(".hero-bag1-wrapper .hero-item").click();
    cy.get(".hero-bag1-wrapper li").first().next().click();
    cy.get(".hero-bag1-wrapper .hero-item").should("have.value", "Scroll of Charm");
  ...
  it("can search for an item", () => {
    cy.get(".hero-bag1-wrapper .hero-item").type("Vow Ke");
    cy.get(".hero-bag1-wrapper li").first().click();
    cy.get(".hero-bag1-wrapper .hero-item").should("have.value", "Vow Keeper");
  });
  it("can clear item", () => {
    cy.get(".hero-bag1-wrapper .hero-item").click();
    cy.get(".hero-bag1-wrapper li").first().click();
