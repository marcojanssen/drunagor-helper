...
.multiselect {
  ...
  @apply border-accent/30 !important;
}
...
.multiselect-search {
  @apply bg-transparent h-9 !important;
}
.multiselect-tags-search {
  @apply bg-transparent h-5 !important;
}
...
.multiselect-option.is-selected {
  @apply text-black bg-primary !important;
}
.multiselect-option.is-pointed {
  @apply text-white bg-accent/30 !important;
}
.multiselect-option.is-disabled {
  @apply hidden !important;
}
.multiselect-no-options {
  @apply text-white bg-neutral !important;
}
.multiselect-no-results {
  @apply text-white bg-neutral !important;
}
.multiselect-tag {
  @apply bg-primary font-normal text-black !important;
}
.multiselect-tag-remove-icon {
  @apply invert opacity-100 !important;
}
.multiselect-caret {
  @apply opacity-100 !important;
}
