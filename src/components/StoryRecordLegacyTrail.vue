...
<template>
  <div id="story-record-legacy-trail" class="bg-neutral form-control w-full">
    ...
    <div class="flex flex-row">
      ...
      <div class="w-1/2 lg:w-1/4 grid grid-cols-4 place-items-end">
        <input type="radio" v-model="doom" name="heroism" value="0" class="text-emerald-500 bg-base-100 focus:ring-0" />
        <input type="radio" v-model="doom" name="heroism" value="1" class="text-emerald-500 bg-base-100 focus:ring-0" />
        <input type="radio" v-model="doom" name="heroism" value="2" class="text-emerald-500 bg-base-100 focus:ring-0" />
        <input type="radio" v-model="doom" name="heroism" value="3" class="text-emerald-500 bg-base-100 focus:ring-0" />
      </div>
    </div>
  </div>
</template>
